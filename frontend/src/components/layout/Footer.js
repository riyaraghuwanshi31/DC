    ...
    <footer className="bg-dark-950 border-t border-dark-800 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-3 mt-5">
              <a href="https://wa.me/919301394684" target="_blank" rel="noreferrer"
        ...
        <div className="border-t border-dark-800 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-dark-500 text-sm">© 2024 Dubey Creation. All rights reserved.</p>
          <p className="text-dark-500 text-sm">Orders via <span className="text-green-400 font-medium">WhatsApp</span> only · No payment gateway</p>
        </div>
      </div>
    </footer>
  );
